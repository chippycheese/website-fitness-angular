...
import { DashboardHealthStatsComponent } from '../../dashboard-health-stats/dashboard-health-stats.component';
...
@Component({
  ...
  standalone: true,
  imports: [DashboardHealthStatsComponent, DashboardMuscleGroupCardComponent, NgFor, KeyValuePipe], 
